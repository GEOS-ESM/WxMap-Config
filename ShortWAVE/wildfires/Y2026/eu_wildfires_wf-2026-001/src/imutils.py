...
def im_draw_places(im, places, font_name, font_size, font_color=(255,255,255), shadow_color=(0,0,0), position='c'):
    ...
    for place in places:
        ...
        x, y = str_position(xo, yo, w, h, position)
     #  x = xo-w/2
     #  y = yo-h/2
...
def image_trim(im, margin=0, bbox=None):
